...
export const routes: Routes = [
  ...
  { path: 'local/classic/:channel_id', component: MonitorPageComponent, pathMatch: 'prefix', canActivate: [AuthGuard], data: { gameType: 'local', actionType: 'join_specific' } },
  { path: 'local/classic/:channel_id/:arena_id', component: GamePageComponent, pathMatch: 'prefix', canActivate: [AuthGuard], data: { gameType: 'local' } },
  ...
  { path: 'online/tournament/:channel_id', component: TournamentPageComponent, pathMatch: 'full', canActivate: [AuthGuard] },
  ...
  { path: 'online/classic/:channel_id', component: MonitorPageComponent, pathMatch: 'full', canActivate: [AuthGuard], data: { gameType: 'online', actionType: 'join_specific'} },
  { path: 'online/classic/:channel_id/:arena_id', component: GamePageComponent, pathMatch: 'prefix', canActivate: [AuthGuard], data: { gameType: 'online' } },
